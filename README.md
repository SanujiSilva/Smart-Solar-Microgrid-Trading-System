...
Maps key configuration arrives in Phase 20. IIS publishing, HTTPS, and production configuration instructions arrive in Phase 24. These are planned client/deployment deliverables; Phases 1-18 are implemented now.
...
The [Phase 1](docs/phase-1.md), [Phase 2](docs/phase-2.md), [Phase 3](docs/phase-3.md), and [Phase 4](docs/phase-4.md) notes remain historical records. Android booking, Maps, QR/operator integration and IIS deployment remain for later phases.
